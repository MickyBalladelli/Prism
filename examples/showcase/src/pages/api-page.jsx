...
const apiGroups = [
  ...
  },
  {
    ...
    components: [
      ...
      { name: 'AutoComplete', props: [['options', 'AutoCompleteOptionInput[] | Reactive<...>', '[]'], ['value', 'string | number | Reactive<...>', "''"], ['minChars / placement', 'number / bottom | top', '0 / bottom'], ['loading / noOptionsText', 'boolean / string', 'false / No matches found']], events: 'onInput, onChange, onSelect, onFocus, onBlur', a11y: 'Editable combobox with listbox semantics, active descendant, keyboard navigation, and an accessible label.' },
      ...
      { name: 'FilePicker', props: [['accept', 'string | Reactive<string>', '—'], ['multiple', 'boolean | Reactive<boolean>', 'false'], ['buttonLabel / emptyText', 'unknown | Reactive<unknown>', 'Choose file / No files selected'], ['disabled / required', 'boolean | Reactive<boolean>', 'false / false']], events: 'onInput, onChange, onFocus, onBlur', a11y: 'Uses a visually styled native file input with an associated label, selection summary, and described-by support.' },
  ...
  },
  {
    ...
    components: [
      { name: 'Avatar / Tag', props: [['name / children', 'string | Reactive<string> / unknown', '—'], ['src / tone', 'string / TagTone', '—'], ['size / statusSize / showStatus / icon / dismissible / removable', 'AvatarSize / small | medium | large / boolean / unknown / boolean / boolean', 'medium / large / true / — / false / false']], events: 'onDismiss / onRemove (Tag)', a11y: 'Avatar alt text, optional icons, and Tag dismiss labeling keep identity and metadata understandable.' },
      ...
      { name: 'Stack / Grid', props: [['direction / columns', 'row | column / string | number', 'column / auto-fit'], ['gap', 'SpacingToken', 'medium'], ['align / wrap / minColumnWidth', 'left | center | right / boolean / string', '— / false / 14rem']], events: '—', a11y: 'Layout-only wrappers; Stack align controls horizontal content placement and preserves heading and landmark semantics in children.' },
