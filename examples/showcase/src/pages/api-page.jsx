...
const apiGroups = [
  ...
  },
  {
    ...
    components: [
      ...
      { name: 'Progress', props: [['value', 'number | Reactive<number>', '—'], ['max', 'number | Reactive<number>', '100'], ['indeterminate', 'boolean | Reactive<boolean>', 'false'], ['showValue', 'boolean', 'false']], events: '—', a11y: 'Uses progressbar semantics with value text when determinate.' },
