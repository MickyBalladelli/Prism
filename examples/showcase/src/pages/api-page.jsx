...
const apiGroups = [
  ...
  },
  {
    ...
    components: [
      { name: 'Avatar / Tag', props: [['name / children', 'string | Reactive<string> / unknown', '—'], ['src / tone', 'string / TagTone', '—'], ['size / statusSize / showStatus / removable', 'AvatarSize / small | medium | large / boolean / boolean', 'medium / large / true / false']], events: 'onRemove (Tag)', a11y: 'Avatar alt text and Tag remove labeling keep identity and metadata understandable.' },
