      ...
      <section class="example-window chat-window" aria-label="Prism real-time chat">
        ...
        <div class="chat-layout">
          ...
          <Card class="chat-people-card">
            ...
            <div class="chat-people-list"><div><Avatar name="Ada Lovelace" status="online" size="small" /><span><strong>Ada Lovelace</strong><small>Product lead</small></span><Pulse status="success" size="small" animation="once" ariaLabel="Online" /></div><div><Avatar name="Boudica" status="online" size="small" /><span><strong>Boudica</strong><small>Design systems</small></span><Pulse status="success" size="small" animation="once" ariaLabel="Online" /></div><div><Avatar name="Cato" status="away" size="small" /><span><strong>Cato</strong><small>Infrastructure</small></span><Pulse status="warning" size="small" animation="once" ariaLabel="Away" /></div></div>
